            ...
            <div class="shadow-xs overflow-hidden bg-white sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('calendars.store') }}" method="POST">
                        @csrf
                        <div>
                            <label for="name" class="block text-sm/6 font-medium text-gray-900">Nom du Calendrier</label>
                        ...
                        <div class="pt-5">
                            <label for="url" class="block text-sm/6 font-medium text-gray-900">URL du Calendrier</label>
                        ...
                        <div class="pt-10">
                            <button type="submit" type="button"
                                class="shadow-xs rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Ajouter</button>
                        </div>
